...
mod tests {
    ...
    fn event_serializes_to_shared_fields() {
        ...
        assert_eq!(v["action"], "census.group.change");
        assert_eq!(v["target"], "grp_eng");
        assert_eq!(v["severity"], "notice");
        assert_eq!(v["source"], "census");
    }
