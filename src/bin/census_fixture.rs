...
const TEMPLATE_MARKER_CORPUS: &str = "{{THEME_ATTR}} {{COLOR_SCHEME}} {{CSS_PATH}} {{APPBAR}} {{FOOTER}} {{STATS}} {{PROV_TAG}} {{HEAD_ACTION}} {{REPORT_COUNT}} {{GROUP_COUNT}} {{BANNER}} {{BOUNDARY}} {{LEGEND}} {{QUERY}} {{DEPARTMENT_OPTIONS}} {{GROUP_OPTIONS}} {{COUNT}} {{ROWS}} {{GROUPS}} {{ORG_CHART}} {{NAME_TEXT}} {{AVATAR}} {{NAME}} {{TITLE_LINE}} {{EMAIL_LINE}} {{UPDATED}} {{PROVENANCE}} {{DETAILS}} {{REPORTS}} {{BIO}} {{EDIT}} {{CREATE_FORM}} {{CSRF}} {{CARDS}} {{MEMBER_FORM}} {{CHILD_FORM}} {{GROUP_ID}} {{DESCRIPTION}} {{CREATED}} {{DIRECT_COUNT}} {{RESOLVED_COUNT}} {{DIRECT_MEMBERS}} {{RESOLVED_MEMBERS}} {{CHILD_GROUPS}} {{PARENT_GROUPS}} {{PERSON_OPTIONS}} {{CHILD_GROUP_OPTIONS}}";
